...
ROUTES_BEGIN_BOUNDARY = "/* ROUTES BEGIN"
ROUTES_END_BOUNDARY = "ROUTES END */"
        ...
        for i, part_name in enumerate(parts):
            ...
            if LEAF:
                ...
                if not existing_section:
                    ...
                    leafs_with_same_name = list(section.find_leafs(part_name, METHOD_ALL))
...
def parse_routes_repr_file(file: str,
                           rbegin: str = ROUTES_BEGIN_BOUNDARY,
                           rend: str = ROUTES_END_BOUNDARY) -> Iterable[RouteRepr]:
    state = 0
